...
<body>
	<div id="main_content">
		<form id="form1" name="form1" method="post" action="<%=path%>/testDetailInfoServlet">
			<h1>
				<center>
			...
			<label>
				<center>
					<input class="btn btn-default btn-success" type="submit" name="button" id="button" class="btn_grey"
						value="返回" />
				</center>
			</label>
		</form>
