...
public class QuestionModifyServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		List courList=cs.findAllCourses("");
		String id=req.getParameter("id");
		Map qsMap=qs.findQuestionById(Integer.valueOf(id));
		req.setAttribute("courseList", courList);
		req.setAttribute("questionMap",qsMap);
